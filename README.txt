This code has a Breadth First Search and a Depth First Search algorithm that are used on a Graph class. Both are written iteratively.
...
Graphonline has a BFS and DFS search that you can use to test against mine.
